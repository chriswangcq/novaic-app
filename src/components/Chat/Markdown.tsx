 ...
 *
 * Perf: remarkPlugins & components are hoisted to module scope so they are
 * stable references — prevents ReactMarkdown from tearing down and rebuilding
 * the entire VDOM tree on every parent re-render.
 */
...
// ── Stable references hoisted to module scope (perf-critical) ─────────────
